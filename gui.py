...
tk.Label(book_frame, text="Book ID",bg="#f0f4f8", fg="#333").grid(row=0, column=0)
...
tk.Button(book_frame, text="Add Book", command=add_book, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=4, column=1)
...
tk.Button(member_frame, text="Register", command=register_member, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=2, column=1, pady=5)
...
tk.Button(br_frame, text="Borrow", command=borrow_book, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=2, column=1)
...
tk.Button(br_frame, text="Return", command=return_book,  bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=5, column=1)
...
tk.Button(search_frame, text="Search Books", command=search_books, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=0, column=1)
tk.Button(search_frame, text="Search Members", command=search_members, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=0, column=2)
tk.Button(search_frame, text="View Books", command=view_books,  bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=1, column=1)
tk.Button(search_frame, text="View Members", command=view_members, bg="#2f5ba3", fg="white", activebackground="#1f3d6d", activeforeground="white", font=("Arial", 10, "bold")).grid(row=1, column=2)

display_text = tk.Text(root, height=15)
display_text.pack(fill="both", padx=10, pady=10)
